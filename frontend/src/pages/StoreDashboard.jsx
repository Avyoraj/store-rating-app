    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-600">Loading your store dashboard...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center max-w-md">
          ...
          <h1 className="text-2xl font-bold text-gray-900 mb-2">Dashboard Access Error</h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="mt-1 text-gray-600">Welcome back, manage your store performance</p>
            </div>
            <div className="flex gap-3">
              <Button 
                ...
                onClick={() => {
                  console.log('Navigating to store page:', storeInfo.id);
            ...
            <div className="p-6">
              <div className="flex items-center justify-between mb-6">
                ...
                <Button 
                  ...
                  size="sm"
                  onClick={() => {
                    console.log('Navigating to store:', storeInfo.id);
                    navigate(`/store/${storeInfo.id}`);
                  }}
                >
                  View All Reviews
